...
func newAdminUser(db *gorm.DB, opts ...gen.DOOption) adminUser {
	...
	_adminUser.Realname = field.NewString(tableName, "realname")
	_adminUser.AvatarURL = field.NewField(tableName, "avatar_url")
	_adminUser.Access = field.NewString(tableName, "access")
...
func (a *adminUser) updateTableName(table string) *adminUser {
	...
	a.AvatarURL = field.NewField(table, "avatar_url")
...
type IAdminUserDo interface {
	...
	Create(values ...*entity.AdminUser) error
	CreateInBatches(values []*entity.AdminUser, batchSize int) error
	Save(values ...*entity.AdminUser) error
	First() (*entity.AdminUser, error)
	Take() (*entity.AdminUser, error)
	Last() (*entity.AdminUser, error)
	Find() ([]*entity.AdminUser, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.AdminUser, err error)
	FindInBatches(result *[]*entity.AdminUser, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*entity.AdminUser) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*entity.AdminUser, error)
	FirstOrCreate() (*entity.AdminUser, error)
	FindByPage(offset int, limit int) (result []*entity.AdminUser, count int64, err error)
