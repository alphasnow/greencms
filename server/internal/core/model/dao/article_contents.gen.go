...
func newArticleContent(db *gorm.DB, opts ...gen.DOOption) articleContent {
	...
	_articleContent.articleContentDo.UseModel(&entity.ArticleContent{})

	tableName := _articleContent.articleContentDo.TableName()
	_articleContent.ALL = field.NewAsterisk(tableName)
	_articleContent.ArticleID = field.NewUint(tableName, "article_id")
...
type IArticleContentDo interface {
	...
	Create(values ...*entity.ArticleContent) error
	CreateInBatches(values []*entity.ArticleContent, batchSize int) error
	Save(values ...*entity.ArticleContent) error
	First() (*entity.ArticleContent, error)
	Take() (*entity.ArticleContent, error)
	Last() (*entity.ArticleContent, error)
	Find() ([]*entity.ArticleContent, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.ArticleContent, err error)
	FindInBatches(result *[]*entity.ArticleContent, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*entity.ArticleContent) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*entity.ArticleContent, error)
	FirstOrCreate() (*entity.ArticleContent, error)
	FindByPage(offset int, limit int) (result []*entity.ArticleContent, count int64, err error)
...
func (a articleContentDo) Create(values ...*entity.ArticleContent) error {
	if len(values) == 0 {
		return nil
	}
...
func (a articleContentDo) CreateInBatches(values []*entity.ArticleContent, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a articleContentDo) Save(values ...*entity.ArticleContent) error {
	if len(values) == 0 {
		return nil
	}
...
func (a articleContentDo) First() (*entity.ArticleContent, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entity.ArticleContent), nil
	}
}

func (a articleContentDo) Take() (*entity.ArticleContent, error) {
...
func (a articleContentDo) Last() (*entity.ArticleContent, error) {
...
func (a articleContentDo) Find() ([]*entity.ArticleContent, error) {
	result, err := a.DO.Find()
	return result.([]*entity.ArticleContent), err
}

func (a articleContentDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.ArticleContent, err error) {
	buf := make([]*entity.ArticleContent, 0, batchSize)
...
func (a articleContentDo) FindInBatches(result *[]*entity.ArticleContent, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a articleContentDo) FirstOrInit() (*entity.ArticleContent, error) {
...
func (a articleContentDo) FirstOrCreate() (*entity.ArticleContent, error) {
...
func (a articleContentDo) FindByPage(offset int, limit int) (result []*entity.ArticleContent, count int64, err error) {
...
func (a articleContentDo) Delete(models ...*entity.ArticleContent) (result gen.ResultInfo, err error) {
